    ...
    public static void main(String[] arg) {
        ...
        try {
            ...
            while (kpair.isEncrypted()) {
                ...
                int result = JOptionPane.showConfirmDialog(null, ob, "Enter passphrase for " + pkey, JOptionPane.OK_CANCEL_OPTION);
            ...
            JTextField passphraseField = (JTextField) new JPasswordField(20);
            Object[] ob = { passphraseField };
            int result = JOptionPane.showConfirmDialog(null, ob, "Enter new passphrase for " + pkey + " (empty for no passphrase)", JOptionPane.OK_CANCEL_OPTION);
            if (result != JOptionPane.OK_OPTION) {
                System.exit(-1);
            }
            passphrase = passphraseField.getText();
