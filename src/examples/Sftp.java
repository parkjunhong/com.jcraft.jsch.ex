...
public class Sftp {
    ...
    /*
     * public static class MyProgressMonitor implements com.jcraft.jsch.ProgressMonitor{ JProgressBar progressBar;
     * JFrame frame; long count=0; long max=0;
     * 
     * public void init(String info, long max){ this.max=max; if(frame==null){ frame=new JFrame(); frame.setSize(200,
     * 20); progressBar = new JProgressBar(); } count=0;
     * 
     ...
     * System.out.println("!info:"+info+", max="+max+" "+progressBar); } public void count(long count){
     * this.count+=count; System.out.println("count: "+count); progressBar.setValue((int)this.count); } public void
     * end(){ System.out.println("end"); progressBar.setValue((int)this.max); frame.setVisible(false); } }
     */
