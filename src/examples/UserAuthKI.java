...
public class UserAuthKI {
    ...
    public static class MyUserInfo implements UserInfo, UIKeyboardInteractive {
        ...
        public String[] promptKeyboardInteractive(String destination, String name, String instruction, String[] prompt, boolean[] echo) {
            /*
             * //System.out.println("promptKeyboardInteractive"); System.out.println("destination: "+destination);
             * System.out.println("name: "+name); System.out.println("instruction: "+instruction);
             * System.out.println("prompt.length: "+prompt.length); System.out.println("prompt: "+prompt[0]);
             */
            panel = new JPanel();
