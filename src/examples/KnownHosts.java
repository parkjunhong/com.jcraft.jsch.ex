...
public class KnownHosts {
    public static void main(String[] arg) {
        ...
        try {
            ...
            /*
             * // In adding to known_hosts file, host names will be hashed. session.setConfig("HashKnownHosts", "yes");
             */
...

            {
                ...
                System.out.println("HostKey: " + hk.getHost() + " " + hk.getType() + " " + hk.getFingerPrint(jsch));
            }
